...
public class _formCarrinhoCompras_2e_jsp extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _formCarrinhoCompras_2e_jsp page = this;
    ...
    try {
      ...
      out.write(__oracle_jsp_text[1]);
      {
        ...
        __jsp_taghandler_1.setId("carrinhoCompras");
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          out.write(__oracle_jsp_text[2]);
          {
            ...
            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
            {
                    ...
                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                    {
                      do {
                        out.write(__oracle_jsp_text[5]);
                        {
                          ...
                          __jsp_taghandler_5.setUrl("images/titulos/carrinhoCompras.gif");
                      ...
                      out.write(__oracle_jsp_text[8]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                            ...
                            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                            {
                              do {
                                out.write(__oracle_jsp_text[10]);
                                {
                                  ...
                                  __jsp_taghandler_9.setValue("Produto");
                          ...
                          out.write(__oracle_jsp_text[12]);
                          {
                            ...
                            __jsp_taghandler_10.setValue("#{item.produto.nome}");
                      ...
                      out.write(__oracle_jsp_text[14]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                          ...
                          out.write(__oracle_jsp_text[18]);
                          {
                            ...
                            __jsp_taghandler_14.setValue("#{item.produto.categoria}");
                      ...
                      out.write(__oracle_jsp_text[20]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                            ...
                            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                            {
                              do {
                                out.write(__oracle_jsp_text[22]);
                                {
                                  ...
                                  __jsp_taghandler_17.setValue("Marca");
                          ...
                          out.write(__oracle_jsp_text[24]);
                          {
                            ...
                            __jsp_taghandler_18.setValue("#{item.produto.marca}");
                      ...
                      out.write(__oracle_jsp_text[26]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                            ...
                            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                            {
                              do {
                                out.write(__oracle_jsp_text[28]);
                                {
                                  ...
                                  __jsp_taghandler_21.setValue("Pre&ccedil;o Unit.");
                          ...
                          out.write(__oracle_jsp_text[30]);
                          {
                            ...
                            __jsp_taghandler_22.setValue("#{item.produto.preco}");
                      ...
                      out.write(__oracle_jsp_text[32]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                            ...
                            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                            {
                              do {
                                out.write(__oracle_jsp_text[34]);
                                {
                                  ...
                                  __jsp_taghandler_25.setValue("Quantidade");
                          ...
                          out.write(__oracle_jsp_text[36]);
                          {
                            ...
                            __jsp_taghandler_26.setValue("#{item.quantidade}");
                      ...
                      out.write(__oracle_jsp_text[38]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                          out.write(__oracle_jsp_text[39]);
                          {
                            ...
                            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                            {
                              do {
                                ...
                                {
                                  com.sun.faces.taglib.html_basic.OutputTextTag __jsp_taghandler_29=(com.sun.faces.taglib.html_basic.OutputTextTag)OracleJspRuntime.getTagHandler(pageContext,com.sun.faces.taglib.html_basic.OutputTextTag.class,"com.sun.faces.taglib.html_basic.OutputTextTag value escape");
                                  __jsp_taghandler_29.setParent(__jsp_taghandler_28);
                                  __jsp_taghandler_29.setValue("Pre&ccedil;o Total");
                                  __jsp_taghandler_29.setEscape("false");
                          ...
                          out.write(__oracle_jsp_text[42]);
                          {
                            ...
                            __jsp_taghandler_30.setValue("#{item.produto.preco*item.quantidade}");
              ...
              {
                com.sun.faces.taglib.html_basic.PanelGridTag __jsp_taghandler_31=(com.sun.faces.taglib.html_basic.PanelGridTag)OracleJspRuntime.getTagHandler(pageContext,com.sun.faces.taglib.html_basic.PanelGridTag.class,"com.sun.faces.taglib.html_basic.PanelGridTag columns width");
                __jsp_taghandler_31.setParent(__jsp_taghandler_2);
                __jsp_taghandler_31.setColumns("2");
                __jsp_taghandler_31.setWidth("100%");
                __jsp_tag_starteval=__jsp_taghandler_31.doStartTag();
                if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                {
                  out.write(__oracle_jsp_text[47]);
                  {
                    com.sun.faces.taglib.html_basic.CommandLinkTag __jsp_taghandler_32=(com.sun.faces.taglib.html_basic.CommandLinkTag)OracleJspRuntime.getTagHandler(pageContext,com.sun.faces.taglib.html_basic.CommandLinkTag.class,"com.sun.faces.taglib.html_basic.CommandLinkTag action");
                    __jsp_taghandler_32.setParent(__jsp_taghandler_31);
                    __jsp_taghandler_32.setAction("catalogoProdutos");
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      do {
                        ...
                        {
                          com.sun.faces.taglib.html_basic.GraphicImageTag __jsp_taghandler_33=(com.sun.faces.taglib.html_basic.GraphicImageTag)OracleJspRuntime.getTagHandler(pageContext,com.sun.faces.taglib.html_basic.GraphicImageTag.class,"com.sun.faces.taglib.html_basic.GraphicImageTag value alt height onmouseout onmouseover width");
                          __jsp_taghandler_33.setParent(__jsp_taghandler_32);
                          __jsp_taghandler_33.setValue("images/button/Bt_continuarComprando.gif");
                          __jsp_taghandler_33.setAlt("Continuar Comprando");
                          __jsp_taghandler_33.setHeight("37");
                          __jsp_taghandler_33.setOnmouseout("MM_swapImgRestore()");
                          __jsp_taghandler_33.setOnmouseover("MM_swapImage('continuarComprando','','images/button/Bt_continuarComprando_on.gif',1)");
                          __jsp_taghandler_33.setWidth("50");
                  ...
                  out.write(__oracle_jsp_text[50]);
                  {
                    ...
                    __jsp_taghandler_34.setAction("finalizarPedido");
                    ...
                    if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                    {
                      ...
                      do {
                        ...
                        {
                          com.sun.faces.taglib.html_basic.GraphicImageTag __jsp_taghandler_35=(com.sun.faces.taglib.html_basic.GraphicImageTag)OracleJspRuntime.getTagHandler(pageContext,com.sun.faces.taglib.html_basic.GraphicImageTag.class,"com.sun.faces.taglib.html_basic.GraphicImageTag value alt height onmouseout onmouseover width");
                          __jsp_taghandler_35.setParent(__jsp_taghandler_34);
                          __jsp_taghandler_35.setValue("images/button/Bt_finalizarPedido_on.gif");
                          __jsp_taghandler_35.setAlt("Finalizar Pedido");
                          __jsp_taghandler_35.setHeight("37");
                          __jsp_taghandler_35.setOnmouseout("MM_swapImgRestore()");
                          __jsp_taghandler_35.setOnmouseover("MM_swapImage('finalizarPedido','','images/button/Bt_finalizarPedido.gif',1)");
                          __jsp_taghandler_35.setWidth("50");
