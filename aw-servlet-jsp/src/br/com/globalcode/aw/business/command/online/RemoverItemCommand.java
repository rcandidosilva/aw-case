...
public class RemoverItemCommand implements WebCommand{
    ...
    public void doAction(HttpServletRequest request, HttpServletResponse response) throws WebCommandException {
        ...
        try{
            ...
            throw new WebCommandException("[removerItem] id de produto invalido",e);
        }
        try{
            ...
            throw new WebCommandException("[online.RemoverItem]" + ex.getMessage(),ex);
        }
