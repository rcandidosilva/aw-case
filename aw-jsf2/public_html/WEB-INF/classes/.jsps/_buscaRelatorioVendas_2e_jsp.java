...
public class _buscaRelatorioVendas_2e_jsp extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _buscaRelatorioVendas_2e_jsp page = this;
    ...
    try {
      ...
      out.write(__oracle_jsp_text[1]);
      {
        ...
        __jsp_taghandler_1.setId("buscaRelatorioVendas");
                    ...
                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                    {
                      do {
                        out.write(__oracle_jsp_text[5]);
                        {
                          ...
                          __jsp_taghandler_5.setValue("Ver relat&oacute;rio de vendas por marca");
                      ...
                      out.write(__oracle_jsp_text[9]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                          out.write(__oracle_jsp_text[10]);
                          {
                            ...
                            __jsp_taghandler_9.setValue("#{RelatorioVendasPorMarcaMB.dataInicio}");
                      ...
                      out.write(__oracle_jsp_text[14]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                          out.write(__oracle_jsp_text[15]);
                          {
                            ...
                            __jsp_taghandler_13.setValue("#{RelatorioVendasPorMarcaMB.dataFinal}");
