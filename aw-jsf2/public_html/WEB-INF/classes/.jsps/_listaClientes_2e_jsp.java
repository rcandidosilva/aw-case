...
public class _listaClientes_2e_jsp extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _listaClientes_2e_jsp page = this;
    ...
    try {
      ...
      out.write(__oracle_jsp_text[2]);
      {
        ...
        __jsp_taghandler_1.setId("listaClientes");
            ...
            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
            {
              out.write(__oracle_jsp_text[4]);
              {
                ...
                if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                {
                    ...
                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                    {
                      do {
                        out.write(__oracle_jsp_text[6]);
                        {
                          ...
                          __jsp_taghandler_5.setUrl("images/titulos/listarClientes.gif");
                  ...
                  {
                    com.sun.faces.taglib.html_basic.DataTableTag __jsp_taghandler_6=(com.sun.faces.taglib.html_basic.DataTableTag)OracleJspRuntime.getTagHandler(pageContext,com.sun.faces.taglib.html_basic.DataTableTag.class,"com.sun.faces.taglib.html_basic.DataTableTag value var headerClass");
                    __jsp_taghandler_6.setParent(__jsp_taghandler_3);
                    __jsp_taghandler_6.setValue("#{ClienteMB.clientes}");
                    __jsp_taghandler_6.setVar("cliente");
                    ...
                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                    {
                      out.write(__oracle_jsp_text[9]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                          ...
                          out.write(__oracle_jsp_text[13]);
                          {
                            ...
                            __jsp_taghandler_10.setAction("#{ClienteMB.viewDetail}");
                            ...
                            if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                            {
                              ...
                              do {
                                out.write(__oracle_jsp_text[14]);
                                {
                                  ...
                                  __jsp_taghandler_11.setValue("#{cliente.nome}");
                      ...
                      out.write(__oracle_jsp_text[17]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                            ...
                            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                            {
                              do {
                                out.write(__oracle_jsp_text[19]);
                                {
                                  ...
                                  __jsp_taghandler_14.setValue("Telefone");
                          ...
                          out.write(__oracle_jsp_text[21]);
                          {
                            ...
                            __jsp_taghandler_15.setValue("#{cliente.telefone}");
                      ...
                      out.write(__oracle_jsp_text[23]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                            ...
                            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                            {
                              do {
                                out.write(__oracle_jsp_text[25]);
                                {
                                  ...
                                  __jsp_taghandler_18.setValue("Email");
                          ...
                          out.write(__oracle_jsp_text[27]);
                          {
                            ...
                            __jsp_taghandler_19.setValue("#{cliente.email}");
                      ...
                      out.write(__oracle_jsp_text[29]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                            ...
                            if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                            {
                              do {
                                out.write(__oracle_jsp_text[31]);
                                {
                                  ...
                                  __jsp_taghandler_22.setValue("Ativo");
                          ...
                          {
                            com.sun.faces.taglib.html_basic.SelectBooleanCheckboxTag __jsp_taghandler_23=(com.sun.faces.taglib.html_basic.SelectBooleanCheckboxTag)OracleJspRuntime.getTagHandler(pageContext,com.sun.faces.taglib.html_basic.SelectBooleanCheckboxTag.class,"com.sun.faces.taglib.html_basic.SelectBooleanCheckboxTag value disabled");
                            __jsp_taghandler_23.setParent(__jsp_taghandler_20);
                            __jsp_taghandler_23.setValue("#{cliente.ativo}");
