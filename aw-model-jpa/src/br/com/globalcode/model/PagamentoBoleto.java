...
public class PagamentoBoleto extends Pagamento {
    ...
    public PagamentoBoleto(Date dataPagamento, double valor, String cedente,
	    String sacado, String numeroCodigoBarras, Date dataVencimento,
	    Banco banco) {
    ...
    public PagamentoBoleto(Integer id, Date dataPagamento, double valor,
	    String cedente, String sacado, String numeroCodigoBarras,
	...
	if (o instanceof PagamentoBoleto) {
	    ...
	    result = this.getNumeroCodigoBarras() != null
		    ...
		    && this.getNumeroCodigoBarras().equals(
			    outro.getNumeroCodigoBarras())
    ...
    @Override
    public int hashCode() {
	int result = getNumeroCodigoBarras() != null ? getNumeroCodigoBarras()
		.hashCode() : 41;
