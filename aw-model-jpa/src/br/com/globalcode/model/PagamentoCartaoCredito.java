...
public class PagamentoCartaoCredito extends Pagamento {
    ...
    public PagamentoCartaoCredito(Date dataPagamento, double valor,
	    BandeiraCartaoCredito bandeiraCartaoCredito, String nomeTitular,
	    String numeroCartao, long numeroConfirmacao, Date dataValidadeCartao) {
    ...
    public PagamentoCartaoCredito(Integer id, Date dataPagamento, double valor,
	    BandeiraCartaoCredito bandeiraCartaoCredito, String nomeTitular,
	    String numeroCartao, long numeroConfirmacao, Date dataValidadeCartao) {
	this(dataPagamento, valor, bandeiraCartaoCredito, nomeTitular,
    ...
    public void setBandeiraCartaoCredito(
    ...
    @Override
    public int hashCode() {
	int result = getNumeroCartao() != null ? getNumeroCartao().hashCode()
		: 47;
	result = (getDataPagamento() != null ? getDataPagamento().hashCode()
		: 41)
		+ 13 * result;
	return result;
    }
