...
public class _formBuscaPedidos_2e_jsp extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    _formBuscaPedidos_2e_jsp page = this;
    ...
    try {
      ...
      out.write(__oracle_jsp_text[1]);
      {
        ...
        __jsp_taghandler_1.setId("formBuscaPedidos");
                ...
                if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                {
                    ...
                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                    {
                      do {
                        out.write(__oracle_jsp_text[5]);
                        {
                          ...
                          __jsp_taghandler_5.setValue("Ver meus pedidos");
                  ...
                  out.write(__oracle_jsp_text[7]);
                  {
                    ...
                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                    {
                      ...
                      out.write(__oracle_jsp_text[9]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                          out.write(__oracle_jsp_text[10]);
                          {
                            ...
                            __jsp_taghandler_9.setValue("#{PedidoMB.dataInicio}");
                      ...
                      out.write(__oracle_jsp_text[14]);
                      {
                        ...
                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                        {
                          out.write(__oracle_jsp_text[15]);
                          {
                            ...
                            __jsp_taghandler_13.setValue("#{PedidoMB.dataFinal}");
                      ...
                      {
                        com.sun.faces.taglib.html_basic.CommandButtonTag __jsp_taghandler_15=(com.sun.faces.taglib.html_basic.CommandButtonTag)OracleJspRuntime.getTagHandler(pageContext,com.sun.faces.taglib.html_basic.CommandButtonTag.class,"com.sun.faces.taglib.html_basic.CommandButtonTag action id value");
                        __jsp_taghandler_15.setParent(__jsp_taghandler_6);
                        __jsp_taghandler_15.setAction("#{PedidoMB.buscarPedidos}");
                        __jsp_taghandler_15.setId("buscar");
